...
EOF
    ...
    echo "\033[43;42m电脑端请下载/etc/wireguard/client.conf，手机端可直接使用软件扫码\033[0m"
...
add_user(){
    echo "\033[37;41m给新用户起个名字，不能和已有用户重复\033[0m"
...
EOF
    ...
    echo "\033[37;41m添加完成，文件：/etc/wireguard/$newname.conf\033[0m"
